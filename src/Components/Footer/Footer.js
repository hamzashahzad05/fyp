            ...
            <Row>
              <Col md={6}>
                  <div className="left_foot_holder">
                    <h4 className='get_lastest_htag'>Get the lastest game news</h4>
                    <div className='foot_input_hold'>
                        <Form className='foot_requestinformation_form position-relative'>
                                <Form.Group  controlId="exampleForm.ControlInput1">
                                    <Form.Control type="email" className='foot_requestinformation_input_area' placeholder="Enter your email" />
                                </Form.Group> 
              ...
              <Col md={6}>
                  <div className="right_foot_holder">
                    <h4 className='join_elumnt_htag'>join game community</h4>
            ...
            <Row>
              <Col md={4} sm={12}>
                <div className="holder_elumt_tag">
                  <h4 className='elumnt_text'>Mini games</h4>
                  <p>One of the lagest multi-chain marketplace for game collectibles.Discover new and exclusive games worldwide.</p>
        ...
        <div className="footer_bottom">
          <Container>
            <div className="holder_bottom_foot d-flex justify-content-center">
              ...
              <h4>MiniGames,LLC. All Rights Reserved</h4>
            </div>
          </Container>
        </div>
    </footer>
